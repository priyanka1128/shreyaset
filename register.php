...
$sms_code=mysqli_query($db,"insert into sms_code (mobile,code) values ('$mobile','$otp')");
// if($sms_code){
// sendSms($mobile, $otp);
// $temp["status"] = "Ok";
...
$message = urlencode("Hello! Welcome To Shreyas. Your registration  otp is : ".$otp);
var_dump($message);
$route = "route=4";
...
<div class="fadeIn first">
      <img src="images/shreyasET.png" id="icon" alt="User Icon" />
    </div>
   <br>

    <!-- Login Form -->
    <form method="post" action="otp_verify.php">
      <input type="text" id="login" class="fadeIn second" name="login" placeholder="Enter Your OTP">
